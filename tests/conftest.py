...
@pytest.fixture()
def test_data():
    return dict(kind="youtube#channelListResponse", etag="8SOBGAWTP6WNDIT9aoovx8H7Gtk", pageInfo={
      "totalResults": 1,
      "resultsPerPage": 5
    }, items=[dict(kind="youtube#channel", etag="FpBWEyPdGpIRWEvE-8KC59BoJu0", id="UCMCgOm8GZkHp8zJ6l7_hIuA", snippet={
      "title": "вДудь",
